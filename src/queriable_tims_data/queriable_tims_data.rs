...
pub struct QueriableTimsData<'a, ID, TA, TL, QF, AE, OE, AG>
where
...
impl<'a, ID, TA, TL, QF, AE, OE, AG> QueriableTimsData<'a, ID, TA, TL, QF, AE, OE, AG>
where
    AG: Aggregator<AE, Output = OE> + Send + Sync,
    ID: IndexedData<QF, AE>,
    TA: ToleranceAdapter<QF>,
...
pub fn query_multi_group<'a, ID, TA, TL, QF, AE, OE, AG>(
    indexed_data: &'a ID,
